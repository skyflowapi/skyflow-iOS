//
//  CollectInputFormattingViewController.swift
//  InputFormatting
//
...
// Input formatting (format:/translation:) demonstrated through a plain CollectContainer -
// unchanged from this project's original single-screen demo, just renamed and moved into its
// own file to make room for the ComposableContainer variant (ComposableInputFormattingViewController.swift).

import UIKit
import SkyflowFlowVault

class CollectInputFormattingViewController: UIViewController {
