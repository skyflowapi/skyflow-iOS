...
public class TextField: SkyflowElement, Element, BaseElement {
    ...
    public var onFocusIsTrue: (() -> Void)?
    public var textField = FormatTextField(frame: .zero)
    public var errorMessage = PaddingLabel(frame: .zero)
    public var isDirty = false
    public var validationRules = ValidationSet()
    public var userValidationRules = ValidationSet()
    public var stackView = UIStackView()
    public var textFieldLabel = PaddingLabel(frame: .zero)
    public var hasBecomeResponder: Bool = false
    public var copyIconImageView: UIImageView?
    public var cardIconAlignment: CardIconAlignment = .left
    public var rightViewForIcons = UIView()
    public var copyContainerView = UIView()
    public var cardIconContainerView = UIView()
    
    public var textFieldDelegate: UITextFieldDelegate? = nil
    
    public var errorTriggered: Bool = false
    
    public var isErrorMessageShowing: Bool {
        return self.errorMessage.alpha == 1.0
    }

    public var listCardTypes: [CardType]?
    public var dropdownButton = UIButton()
    public var selectedCardBrand: CardType? = nil
    ...
    public var textFieldPadding = UIEdgeInsets(top: 0, left: 0, bottom: 0, right: 0) {
    ...
    override public init(input: CollectElementInput, options: CollectElementOptions, contextOptions: ContextOptions, elements: [TextField]? = nil) {
    ...
    public func addDateValidations() {
    ...
    public func addMonthValidations() {
    ...
    public var onChangeHandler: (([String: Any]) -> Void)?
    public var onBlurHandler: (([String: Any]) -> Void)?
    public var onReadyHandler: (([String: Any]) -> Void)?
    public var onFocusHandler: (([String: Any]) -> Void)?
    public var onSubmitHandler: (() -> Void)?

    
    override public func getOutput() -> String? {
    ...
    public func getOutputTextwithoutFormatPattern() -> String? {
    ...
    override public func setupField() {
        super.setupField()
    ...
    public func updateImage(name: String, cardNumber: String){
        var name = name
...
//        dropdownIcon.frame = CGRect(x: imageView.frame.width + 7, y: containerView.frame.height / 3, width: 12, height: 15)
    ...
    override public func validate() -> SkyflowValidationError {
        let str = actualValue
...
extension TextField {
    ...
    public func updateInputStyle(_ style: Style? = nil) {
    ...
    public func updateLabelStyle(_ style: Style? = nil) {
    ...
    public func updateErrorMessage() {
