...
public class Label: UIView, Element, BaseElement {
    public var skyflowLabelView: SkyflowLabelView!
    public var revealInput: RevealElementInput!
    public var options: RevealElementOptions!
    public var stackView = UIStackView()
    public var labelField = PaddingLabel(frame: .zero)
    public var errorMessage = PaddingLabel(frame: .zero)
    
    public var errorTriggered: Bool = false
    public var triggeredErrorMessage: String = ""
    public var uuid: String = ""
    
    public var actualValue: String? = nil

    public var horizontalConstraints = [NSLayoutConstraint]()

    public var verticalConstraint = [NSLayoutConstraint]()

    public init(input: RevealElementInput, options: RevealElementOptions) {
    ...
    public func updateVal(value: String) {
...
//        stackView.distribution = .equalSpacing
    ...
    public func getValueForConnections() -> String {
        if actualValue != nil {
            return getValue()
        } else {
            return getToken()
