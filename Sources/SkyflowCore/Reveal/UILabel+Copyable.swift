...
public extension UILabel {
    ...
    /// Used to enable/disable the public long press gesture recognizer. Defaults to `true`.
    ...
    fileprivate func setupCopyIcon() {
        ...
        @objc public func copyIconTapped(_ sender: UITapGestureRecognizer) {
            // Copy text when the copy icon is tapped
            copy(sender)
        }
 
    @objc public func longPressGestureRecognized(gestureRecognizer: UIGestureRecognizer) {
