...
public class Log {
    public static func debug(message: Message, values: [String] = [], contextOptions: ContextOptions) {
    ...
    public static func info(message: Message, values: [String] = [], contextOptions: ContextOptions) {
    ...
    public static func warn(message: Message, values: [String] = [], contextOptions: ContextOptions) {
    ...
    public static func error(message: String, values: [String] = [], contextOptions: ContextOptions) {
