...
public class SkyflowElement: UIView {
    ...
    package var fieldType: ElementType!
    package var columnName: String!
    ...
    package func getState() -> [String: Any] {
    ...
    internal init(input: BaseCollectElementInput, options: BaseCollectElementOptions, contextOptions: ContextOptions, elements: [TextField]) {
