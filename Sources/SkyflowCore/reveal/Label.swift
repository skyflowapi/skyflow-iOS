...
public class Label: UIView, Element, BaseElement {
    ...
    internal var options: BaseRevealElementOptions!
    internal var stackView = UIStackView()
    internal var labelField = PaddingLabel(frame: .zero)
    internal var errorMessage = PaddingLabel(frame: .zero)
    
    package var errorTriggered: Bool = false
    package var triggeredErrorMessage: String = ""
    ...
    internal init(input: BaseRevealElementInput, options: BaseRevealElementOptions) {
    ...
    package func updateVal(value: String) {
...
//        stackView.distribution = .equalSpacing
    ...
    package func getToken() -> String{
        return self.revealInput.token
    }
    
    package func getValueForConnections() -> String {
        if actualValue != nil {
            return getValue()
        } else {
            return getToken()
