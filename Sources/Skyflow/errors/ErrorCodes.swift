...
internal enum ErrorCodes: CustomStringConvertible {
    ...
    case INVALID_REQUEST_XML(code: Int = 400, message: String = "Invalid Request in SoapConnection")
    case INVALID_RESPONSE_XML(code: Int = 400, message: String = "Invalid Response in SoapConnection")
    case INVALID_ACTUAL_RESPONSE_XML(code: Int = 400, message: String = "Invalid Response returned from server in SoapConnection")
