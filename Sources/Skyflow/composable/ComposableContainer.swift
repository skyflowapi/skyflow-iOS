...
public extension Container {
    ...
    func getComposableView() throws -> UIView {
        return try ComposableLayout.getComposableView(elements: elements, containerOptions: containerOptions)
    }

    internal func createRows(from elements: [Int], numberOfRows: Int) -> [[Int]] {
        return ComposableLayout.createRows(from: elements, numberOfRows: numberOfRows)
    }

    internal func updateErrorMessageInLabel(errorList: [String], layout: [Int], labelArray: [UILabel], result: [[Int]]) -> [UILabel] {
        return ComposableLayout.updateErrorMessageInLabel(errorList: errorList, layout: layout, labelArray: labelArray, result: result)
    }

    internal func concatenateStringArray(_ array: [String], from startIndex: Int, to endIndex: Int) -> String {
        return ComposableLayout.concatenateStringArray(array, from: startIndex, to: endIndex)
    }
