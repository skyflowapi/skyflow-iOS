...
//        var updateIndex: Int = 0
    ...
    internal static func createRequestBody2(elements: [TextField], additionalFields: [String: Any]? = nil, callback: Callback, contextOptions: ContextOptions) -> [String: Any]? {
        var tableMap: [String: Int] = [:]
        var payload: [[String: Any]] = []
        self.callback = callback
        self.breakFlag = false
        ...
        return ["records": payload, "update": payload]
    }
