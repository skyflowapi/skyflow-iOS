...
internal class Type
{
    ...
    internal required init(
        ...
        acceptableCharacters: CharacterSet?=nil,
        maxLength: Int?=nil
    ) {
    ...
    var instance: Type? {
        ...
        case .CARDHOLDER_NAME :
            ...
            return Type(
                ...
                acceptableCharacters: CharacterSet.CardHolderCharacters
            )

        case .CARD_NUMBER :
            rules.add(
                rule: SkyflowValidateCardNumber(
            ...
            return Type(
                ...
                acceptableCharacters: CharacterSet.SkyflowAsciiDecimalDigits
            )
        ...
        case .CVV :
            ...
            rules.add(
                rule: SkyflowValidateLengthMatch(
                    lengths: [3, 4],
                    error: SkyflowValidationErrorType.lengthMatches.rawValue
                )
            )
            return Type(
                formatPattern: "",
