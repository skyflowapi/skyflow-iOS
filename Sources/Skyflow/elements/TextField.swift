...
public class TextField: SkyflowElement, Element {
    ...
    internal var onChangeHandler: (([String: Any]) -> Void)? = nil
    internal var onBlurHandler: (([String: Any]) -> Void)? = nil
    internal var onReadyHandler: (([String: Any]) -> Void)? = nil
    internal var onFocusHandler: (([String: Any]) -> Void)? = nil
