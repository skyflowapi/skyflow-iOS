...
public enum  CardType: CaseIterable {
    ...
    var instance: Card {
        ...
        case .VISA : return Card(
            defaultName: "Visa", regex: "^4\\d*", minCardLength: 13, maxCardLength: 19,
        ...
        case .DISCOVER : return Card(
            ...
            minCardLength: 16, maxCardLength: 16,
        ...
        case .MAESTRO: return Card(
            ...
            minCardLength: 12, maxCardLength: 19,
            formatPattern: "#### #### #### #### ###", securityCodeLength: 3,
        ...
        case .UNIONPAY: return Card(
            ...
            minCardLength: 16, maxCardLength: 19, formatPattern: "#### #### #### #### ###", securityCodeLength: 3,
