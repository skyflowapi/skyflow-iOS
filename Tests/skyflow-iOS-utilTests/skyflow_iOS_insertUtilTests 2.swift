...
final class skyflow_iOS_insertUtilTests: XCTestCase {
    var collectCallback: InsertAPICallback! = nil
    var defaultRecord: [String: Any] = ["records": [["table": "table", "fields": ["field": "value"]]]]
    
    override func setUp() {
        self.collectCallback = InsertAPICallback(callback: DemoAPICallback(expectation: XCTestExpectation()),
    ...
    func testOnlyInsertSuccess() {
        ...
        let collectCallback = InsertAPICallback(
            callback: callback,
