...
//        print(type(of: cardNumberElement))
     //   app.label = cardNumberElement!
  //      var stackView = UIStackView()
   //     stackView.addArrangedSubview(cardNumberElement!)
//        cardNumberElement?.updateVal(value: "12345")
//        XCTAssertEqual(cardNumberElement?.getValue(), "12345")

//
//        let label = SkyflowLabelView(input: RevealElementInput(token: "token", label: "label"), options: RevealElementOptions(format: "X-X-X"))
//        label.updateVal(value: "123")
//        label.getValue()
//        XCTAssertEqual(label.label.secureText, "1-2-3")
//    }
