...
public enum ElementType: Int, CaseIterable {
    ...
    /// Field type that requires Card Expiration Date input formatting and validation, format can be set through BaseCollectElementOptions, defaul is MM/YY
    ...
    /// Field type that requires Card Expiration Year formatting and validation, format can be set through BaseCollectElementOptions for YY, defaul is YYYY
