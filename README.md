...
let cardNumberInput = Skyflow.CollectElementInput(table: "cards", column: "cardNumber", type: Skyflow.ElementType.CARD_NUMBER)
...
- `message` is a description prefixed with the SDK name and version, e.g. `"iOS SDK v1.25.1 Validation error. 'table' key not found in collect element. Specify a valid value for 'table' key."`
